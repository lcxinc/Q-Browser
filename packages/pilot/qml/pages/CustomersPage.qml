...
Item {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            AppButton { id: previousButton; text: "Previous"; enabled: dataModel.customersPage > 1; onClicked: root.previousPage() }
            ...
            AppButton { id: nextButton; text: "Next"; enabled: dataModel.customersPage < dataModel.customersTotalPages; onClicked: root.nextPage() }
        }
    }
}
